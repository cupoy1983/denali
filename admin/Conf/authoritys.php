...
$authoritys['no']['goodscates']['getselect'] = 1;
$authoritys['no']['shop']['getshop'] = 1;
$authoritys['no']['shop']['getgroups'] = 1;
...
$authoritys['actions']['shop']['disables'] = array('disable','removedisables','removeshare','removegoods');
$authoritys['actions']['shop']['remove'] = array('removeshare','removegoods');
...
//敏感词管理权限
$authoritys['actions']['word']['import'] = array('save');

//SEO管理权限
$authoritys['actions']['seo']['down'] = array('downrule');

//邮件内容管理权限
$authoritys['actions']['mailrsscontent']['add'] = array('sendmail');
$authoritys['actions']['mailrsscontent']['update'] = array('sendmail');

//商品同义词库管理权限
$authoritys['actions']['goodsdictionary']['import'] = array('save');
$authoritys['actions']['goodsdictionary']['update'] = array('updatecache');

//锚词库管理权限
$authoritys['actions']['anchor']['import'] = array('save');
$authoritys['actions']['anchor']['update'] = array('updatecache');
...
$authoritys['ckfinder'] = array(
	...
	'mailrsscontent'=>array('add','update'),
);
?>