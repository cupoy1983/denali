...
return array(
	...
	'COMMISSION_RATE_TIP'=>'当会员介绍的朋友购买产生佣金时，返现给会员的佣金百分比',
	'BUY_RATE_TIP'=>'当会员点击淘宝推广商品，成功购买，并产生佣金时，返现给购买会员的佣金百分比；<br/>当发布商品的会员和购买商品的会员为同一个会员时，只会产生<span style="color:#f00;">购买返现</span>，而不会产生<span style="color:#f00;">佣金返现</span>。',
