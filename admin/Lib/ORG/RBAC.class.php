    ...
    static public function getAccessList($authId)
    {
        ...
        foreach($apps as $key=>$app)
		{
            ...
            if($app['auth_type']==0) //节点授权
            {
				...
				if(!$_SESSION['ADMIN_CKFINDER'] && isset($authoritys['ckfinder'][$l_module_name]))
				{
					if(in_array($l_action_name,$authoritys['ckfinder'][$l_module_name]))
						$_SESSION['ADMIN_CKFINDER'] = true;
				}
