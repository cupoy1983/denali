...
class TqqOAuth
{
    ...
    {
		global $_FANWE;
		if(isset($_FANWE['login_oauth']['tqq']))
			unset($_FANWE['login_oauth']['tqq']);
    }
}
...
class TencentTqq
{
    ...
    {
		global $_FANWE;
        if (isset($_FANWE['login_oauth']['tqq']['t_access_token'])) {//OAuth 2.0 方式
            //鉴权参数
            $params['access_token'] = $_FANWE['login_oauth']['tqq']['t_access_token'];
            $params['oauth_consumer_key'] = TqqOAuth::$client_id;
            $params['openid'] = $_FANWE['login_oauth']['tqq']['t_openid'];
        ...
        } elseif (isset($_FANWE['login_oauth']['tqq']['t_openid']) && isset($_FANWE['login_oauth']['tqq']['t_openkey'])) {//openid & openkey方式
            $params['appid'] = TqqOAuth::$client_id;
            $params['openid'] = $_FANWE['login_oauth']['tqq']['t_openid'];
            $params['openkey'] = $_FANWE['login_oauth']['tqq']['t_openkey'];
            $params['clientip'] = TqqCommon::getClientIp();
            $params['reqtime'] = time();
            $params['wbversion'] = '1';
