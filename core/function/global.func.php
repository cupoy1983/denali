...
function setCache($key,$data,$expired_time = 0)
{
	...
	$cache_content = var_export($cache_data, true);
	if(strpos($cache_content,'SimpleXMLElement') !== FALSE)
		return;
...
function setTempCache($key,$data)
{
	...
	$cache_content = var_export($data, true);
	$cache_data = "<?php\n".'return'." ".$cache_content.";\n?>";
	writeFile($cache_path,$cache_data);
